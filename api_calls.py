...
def get_competitor_ads(company_name, product_name):
    url = "http://frozen-celie-bharatavjo-cdf8e0d5.koyeb.app/analyze-competitor-ads"
    payload = {
...
def generate_creative_ideas(competitor_ads, product_name):
    url = "http://frozen-celie-bharatavjo-cdf8e0d5.koyeb.app/generate-ad-ideas"
    payload = {
...
def create_final_ad_text(text_idea,company_name,product_name, custom_text):
    url = "http://frozen-celie-bharatavjo-cdf8e0d5.koyeb.app/generate-marketing-text"
    payload = {
        "idea": text_idea,
        "company_name":company_name,
        "product_name":product_name,
...
def create_final_ad_image(image_idea):
    return {"image_url":"https://img.recraft.ai/b6cLjEzfJGPg4fLSwmCV2U_ACzRyTokSrZARSx2fFo8/rs:fit:1024:1024:0/raw:1/plain/abs://external/images/43d92767-b20c-4caf-90be-2e2629d775fa"}
    url = "http://frozen-celie-bharatavjo-cdf8e0d5.koyeb.app/ggenerate-marketing-image"
    payload = {
        "prompt": image_idea,
